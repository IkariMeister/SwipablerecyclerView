...
public class FtdiSerialDriver extends CommonUsbSerialDriver {
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_RENFE),
                new int[] {
                    UsbId.RENFE_PRODUCT,
                });
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_RENFE_DOS),
                new int[] {
                    UsbId.RENFE_PRODUCT_DOS,
                });
        Log.d("prueba", "esto es una prueba");
